...
internal protocol Google_Pubsub_V1_PublisherProvider: CallHandlerProvider {
  var interceptors: Google_Pubsub_V1_PublisherServerInterceptorFactoryProtocol? { get }
...
extension Google_Pubsub_V1_PublisherProvider {
  internal var serviceName: Substring {
    return Google_Pubsub_V1_PublisherServerMetadata.serviceDescriptor.fullName[...]
  }
  ...
  internal func handle(
    ...
    case "CreateTopic":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_Topic>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Topic>(),
        interceptors: self.interceptors?.makeCreateTopicInterceptors() ?? [],
    ...
    case "UpdateTopic":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_UpdateTopicRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Topic>(),
        interceptors: self.interceptors?.makeUpdateTopicInterceptors() ?? [],
    ...
    case "Publish":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_PublishRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_PublishResponse>(),
        interceptors: self.interceptors?.makePublishInterceptors() ?? [],
    ...
    case "GetTopic":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_GetTopicRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Topic>(),
        interceptors: self.interceptors?.makeGetTopicInterceptors() ?? [],
        userFunction: self.getTopic(request:context:)
      )

    case "ListTopics":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ListTopicsRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListTopicsResponse>(),
        interceptors: self.interceptors?.makeListTopicsInterceptors() ?? [],
        userFunction: self.listTopics(request:context:)
      )

    case "ListTopicSubscriptions":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ListTopicSubscriptionsRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListTopicSubscriptionsResponse>(),
        interceptors: self.interceptors?.makeListTopicSubscriptionsInterceptors() ?? [],
        userFunction: self.listTopicSubscriptions(request:context:)
      )

    case "ListTopicSnapshots":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ListTopicSnapshotsRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListTopicSnapshotsResponse>(),
        interceptors: self.interceptors?.makeListTopicSnapshotsInterceptors() ?? [],
        userFunction: self.listTopicSnapshots(request:context:)
      )

    case "DeleteTopic":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_DeleteTopicRequest>(),
    ...
    case "DetachSubscription":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_DetachSubscriptionRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_DetachSubscriptionResponse>(),
        interceptors: self.interceptors?.makeDetachSubscriptionInterceptors() ?? [],
        userFunction: self.detachSubscription(request:context:)
      )
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Google_Pubsub_V1_PublisherAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Google_Pubsub_V1_PublisherServerInterceptorFactoryProtocol? { get }
  ...
  /// (https://cloud.google.com/pubsub/docs/pubsub-basics#resource_names).
  func createTopic(
    request: Google_Pubsub_V1_Topic,
  ...
  /// mask. Note that certain properties of a topic are not modifiable.
  func updateTopic(
    request: Google_Pubsub_V1_UpdateTopicRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Topic
  ...
  /// does not exist.
  func publish(
    request: Google_Pubsub_V1_PublishRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_PublishResponse

  /// Gets the configuration of a topic.
  func getTopic(
    request: Google_Pubsub_V1_GetTopicRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Topic

  /// Lists matching topics.
  func listTopics(
    request: Google_Pubsub_V1_ListTopicsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_ListTopicsResponse

  /// Lists the names of the attached subscriptions on this topic.
  func listTopicSubscriptions(
    request: Google_Pubsub_V1_ListTopicSubscriptionsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_ListTopicSubscriptionsResponse
  ...
  /// state captured by a snapshot.
  func listTopicSnapshots(
    request: Google_Pubsub_V1_ListTopicSnapshotsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_ListTopicSnapshotsResponse
  ...
  /// not deleted, but their `topic` field is set to `_deleted-topic_`.
  func deleteTopic(
    request: Google_Pubsub_V1_DeleteTopicRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty
  ...
  /// subscription, pushes to the endpoint will stop.
  func detachSubscription(
    request: Google_Pubsub_V1_DetachSubscriptionRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_DetachSubscriptionResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Google_Pubsub_V1_PublisherAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Google_Pubsub_V1_PublisherServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Google_Pubsub_V1_PublisherServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  internal func handle(
    ...
    case "GetTopic":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Topic>(),
        interceptors: self.interceptors?.makeGetTopicInterceptors() ?? [],
        wrapping: { try await self.getTopic(request: $0, context: $1) }
      )
    ...
    case "ListTopics":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListTopicsResponse>(),
        interceptors: self.interceptors?.makeListTopicsInterceptors() ?? [],
        wrapping: { try await self.listTopics(request: $0, context: $1) }
      )
    ...
    case "ListTopicSubscriptions":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListTopicSubscriptionsResponse>(),
        interceptors: self.interceptors?.makeListTopicSubscriptionsInterceptors() ?? [],
        wrapping: { try await self.listTopicSubscriptions(request: $0, context: $1) }
      )
    ...
    case "ListTopicSnapshots":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListTopicSnapshotsResponse>(),
        interceptors: self.interceptors?.makeListTopicSnapshotsInterceptors() ?? [],
        wrapping: { try await self.listTopicSnapshots(request: $0, context: $1) }
      )
    ...
    case "DetachSubscription":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_DetachSubscriptionResponse>(),
        interceptors: self.interceptors?.makeDetachSubscriptionInterceptors() ?? [],
        wrapping: { try await self.detachSubscription(request: $0, context: $1) }
      )
...
internal protocol Google_Pubsub_V1_PublisherServerInterceptorFactoryProtocol: Sendable {

  /// - Returns: Interceptors to use when handling 'createTopic'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeCreateTopicInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_Topic, Google_Pubsub_V1_Topic>]

  /// - Returns: Interceptors to use when handling 'updateTopic'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeUpdateTopicInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_UpdateTopicRequest, Google_Pubsub_V1_Topic>]

  /// - Returns: Interceptors to use when handling 'publish'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makePublishInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_PublishRequest, Google_Pubsub_V1_PublishResponse>]

  /// - Returns: Interceptors to use when handling 'getTopic'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeGetTopicInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_GetTopicRequest, Google_Pubsub_V1_Topic>]

  /// - Returns: Interceptors to use when handling 'listTopics'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeListTopicsInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ListTopicsRequest, Google_Pubsub_V1_ListTopicsResponse>]

  /// - Returns: Interceptors to use when handling 'listTopicSubscriptions'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeListTopicSubscriptionsInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ListTopicSubscriptionsRequest, Google_Pubsub_V1_ListTopicSubscriptionsResponse>]

  /// - Returns: Interceptors to use when handling 'listTopicSnapshots'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeListTopicSnapshotsInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ListTopicSnapshotsRequest, Google_Pubsub_V1_ListTopicSnapshotsResponse>]

  /// - Returns: Interceptors to use when handling 'deleteTopic'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeDeleteTopicInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_DeleteTopicRequest, SwiftProtobuf.Google_Protobuf_Empty>]

  /// - Returns: Interceptors to use when handling 'detachSubscription'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeDetachSubscriptionInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_DetachSubscriptionRequest, Google_Pubsub_V1_DetachSubscriptionResponse>]
}

internal enum Google_Pubsub_V1_PublisherServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Publisher",
    fullName: "google.pubsub.v1.Publisher",
    methods: [
      Google_Pubsub_V1_PublisherServerMetadata.Methods.createTopic,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.updateTopic,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.publish,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.getTopic,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.listTopics,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.listTopicSubscriptions,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.listTopicSnapshots,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.deleteTopic,
      Google_Pubsub_V1_PublisherServerMetadata.Methods.detachSubscription,
    ]
  )
...
///
/// To build a server, implement a class that conforms to this protocol.
internal protocol Google_Pubsub_V1_SubscriberProvider: CallHandlerProvider {
  var interceptors: Google_Pubsub_V1_SubscriberServerInterceptorFactoryProtocol? { get }
...
extension Google_Pubsub_V1_SubscriberProvider {
  internal var serviceName: Substring {
    return Google_Pubsub_V1_SubscriberServerMetadata.serviceDescriptor.fullName[...]
  }
  ...
  internal func handle(
    ...
    case "CreateSubscription":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_Subscription>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Subscription>(),
        interceptors: self.interceptors?.makeCreateSubscriptionInterceptors() ?? [],
    ...
    case "GetSubscription":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_GetSubscriptionRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Subscription>(),
        interceptors: self.interceptors?.makeGetSubscriptionInterceptors() ?? [],
    ...
    case "UpdateSubscription":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_UpdateSubscriptionRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Subscription>(),
        interceptors: self.interceptors?.makeUpdateSubscriptionInterceptors() ?? [],
        userFunction: self.updateSubscription(request:context:)
      )

    case "ListSubscriptions":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ListSubscriptionsRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListSubscriptionsResponse>(),
        interceptors: self.interceptors?.makeListSubscriptionsInterceptors() ?? [],
    ...
    case "DeleteSubscription":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_DeleteSubscriptionRequest>(),
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeDeleteSubscriptionInterceptors() ?? [],
        userFunction: self.deleteSubscription(request:context:)
      )

    case "ModifyAckDeadline":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ModifyAckDeadlineRequest>(),
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeModifyAckDeadlineInterceptors() ?? [],
        userFunction: self.modifyAckDeadline(request:context:)
      )

    case "Acknowledge":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_AcknowledgeRequest>(),
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeAcknowledgeInterceptors() ?? [],
        userFunction: self.acknowledge(request:context:)
      )

    case "Pull":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_PullRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_PullResponse>(),
        interceptors: self.interceptors?.makePullInterceptors() ?? [],
    ...
    case "StreamingPull":
      return BidirectionalStreamingServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_StreamingPullRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_StreamingPullResponse>(),
        interceptors: self.interceptors?.makeStreamingPullInterceptors() ?? [],
        observerFactory: self.streamingPull(context:)
      )

    case "ModifyPushConfig":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ModifyPushConfigRequest>(),
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeModifyPushConfigInterceptors() ?? [],
        userFunction: self.modifyPushConfig(request:context:)
      )

    case "GetSnapshot":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_GetSnapshotRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Snapshot>(),
        interceptors: self.interceptors?.makeGetSnapshotInterceptors() ?? [],
    ...
    case "ListSnapshots":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_ListSnapshotsRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListSnapshotsResponse>(),
        interceptors: self.interceptors?.makeListSnapshotsInterceptors() ?? [],
    ...
    case "CreateSnapshot":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_CreateSnapshotRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Snapshot>(),
        interceptors: self.interceptors?.makeCreateSnapshotInterceptors() ?? [],
        userFunction: self.createSnapshot(request:context:)
      )

    case "UpdateSnapshot":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_UpdateSnapshotRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Snapshot>(),
        interceptors: self.interceptors?.makeUpdateSnapshotInterceptors() ?? [],
        userFunction: self.updateSnapshot(request:context:)
      )

    case "DeleteSnapshot":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_DeleteSnapshotRequest>(),
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeDeleteSnapshotInterceptors() ?? [],
        userFunction: self.deleteSnapshot(request:context:)
      )

    case "Seek":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Google_Pubsub_V1_SeekRequest>(),
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_SeekResponse>(),
        interceptors: self.interceptors?.makeSeekInterceptors() ?? [],
        userFunction: self.seek(request:context:)
      )
...
/// To implement a server, implement an object which conforms to this protocol.
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Google_Pubsub_V1_SubscriberAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Google_Pubsub_V1_SubscriberServerInterceptorFactoryProtocol? { get }
  ...
  /// for REST API requests, you must specify a name in the request.
  func createSubscription(
    request: Google_Pubsub_V1_Subscription,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Subscription

  /// Gets the configuration details of a subscription.
  func getSubscription(
    request: Google_Pubsub_V1_GetSubscriptionRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Subscription
  ...
  /// topic, are not modifiable.
  func updateSubscription(
    request: Google_Pubsub_V1_UpdateSubscriptionRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Subscription

  /// Lists matching subscriptions.
  func listSubscriptions(
    request: Google_Pubsub_V1_ListSubscriptionsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_ListSubscriptionsResponse
  ...
  /// subscription or its topic unless the same topic is specified.
  func deleteSubscription(
    request: Google_Pubsub_V1_DeleteSubscriptionRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty
  ...
  /// subscription-level `ackDeadlineSeconds` used for subsequent messages.
  func modifyAckDeadline(
    request: Google_Pubsub_V1_ModifyAckDeadlineRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty
  ...
  /// than once will not result in an error.
  func acknowledge(
    request: Google_Pubsub_V1_AcknowledgeRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty

  /// Pulls messages from the server.
  func pull(
    request: Google_Pubsub_V1_PullRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_PullResponse
  ...
  /// underlying RPC channel.
  func streamingPull(
    requestStream: GRPCAsyncRequestStream<Google_Pubsub_V1_StreamingPullRequest>,
    responseStream: GRPCAsyncResponseStreamWriter<Google_Pubsub_V1_StreamingPullResponse>,
    context: GRPCAsyncServerCallContext
  ) async throws
  ...
  /// continuously through the call regardless of changes to the `PushConfig`.
  func modifyPushConfig(
    request: Google_Pubsub_V1_ModifyPushConfigRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty
  ...
  /// state captured by a snapshot.
  func getSnapshot(
    request: Google_Pubsub_V1_GetSnapshotRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Snapshot
  ...
  /// state captured by a snapshot.
  func listSnapshots(
    request: Google_Pubsub_V1_ListSnapshotsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_ListSnapshotsResponse
  ...
  /// REST API requests, you must specify a name in the request.
  func createSnapshot(
    request: Google_Pubsub_V1_CreateSnapshotRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Snapshot
  ...
  /// state captured by a snapshot.
  func updateSnapshot(
    request: Google_Pubsub_V1_UpdateSnapshotRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_Snapshot
  ...
  /// snapshot or its subscription, unless the same subscription is specified.
  func deleteSnapshot(
    request: Google_Pubsub_V1_DeleteSnapshotRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty
  ...
  /// snapshot must be on the same topic.
  func seek(
    request: Google_Pubsub_V1_SeekRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Google_Pubsub_V1_SeekResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Google_Pubsub_V1_SubscriberAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Google_Pubsub_V1_SubscriberServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Google_Pubsub_V1_SubscriberServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  internal func handle(
    ...
    case "CreateSubscription":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Subscription>(),
        interceptors: self.interceptors?.makeCreateSubscriptionInterceptors() ?? [],
        wrapping: { try await self.createSubscription(request: $0, context: $1) }
      )
    ...
    case "UpdateSubscription":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Subscription>(),
        interceptors: self.interceptors?.makeUpdateSubscriptionInterceptors() ?? [],
        wrapping: { try await self.updateSubscription(request: $0, context: $1) }
      )
    ...
    case "DeleteSubscription":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeDeleteSubscriptionInterceptors() ?? [],
        wrapping: { try await self.deleteSubscription(request: $0, context: $1) }
      )
    ...
    case "ModifyAckDeadline":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeModifyAckDeadlineInterceptors() ?? [],
        wrapping: { try await self.modifyAckDeadline(request: $0, context: $1) }
      )
    ...
    case "Acknowledge":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeAcknowledgeInterceptors() ?? [],
        wrapping: { try await self.acknowledge(request: $0, context: $1) }
      )
    ...
    case "StreamingPull":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_StreamingPullResponse>(),
        interceptors: self.interceptors?.makeStreamingPullInterceptors() ?? [],
        wrapping: { try await self.streamingPull(requestStream: $0, responseStream: $1, context: $2) }
      )
    ...
    case "ModifyPushConfig":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeModifyPushConfigInterceptors() ?? [],
        wrapping: { try await self.modifyPushConfig(request: $0, context: $1) }
      )
    ...
    case "GetSnapshot":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Snapshot>(),
        interceptors: self.interceptors?.makeGetSnapshotInterceptors() ?? [],
        wrapping: { try await self.getSnapshot(request: $0, context: $1) }
      )
    ...
    case "ListSnapshots":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_ListSnapshotsResponse>(),
        interceptors: self.interceptors?.makeListSnapshotsInterceptors() ?? [],
        wrapping: { try await self.listSnapshots(request: $0, context: $1) }
      )
    ...
    case "CreateSnapshot":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Snapshot>(),
        interceptors: self.interceptors?.makeCreateSnapshotInterceptors() ?? [],
        wrapping: { try await self.createSnapshot(request: $0, context: $1) }
      )
    ...
    case "UpdateSnapshot":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_Snapshot>(),
        interceptors: self.interceptors?.makeUpdateSnapshotInterceptors() ?? [],
        wrapping: { try await self.updateSnapshot(request: $0, context: $1) }
      )
    ...
    case "DeleteSnapshot":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<SwiftProtobuf.Google_Protobuf_Empty>(),
        interceptors: self.interceptors?.makeDeleteSnapshotInterceptors() ?? [],
        wrapping: { try await self.deleteSnapshot(request: $0, context: $1) }
      )
    ...
    case "Seek":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Google_Pubsub_V1_SeekResponse>(),
        interceptors: self.interceptors?.makeSeekInterceptors() ?? [],
        wrapping: { try await self.seek(request: $0, context: $1) }
      )
...
internal protocol Google_Pubsub_V1_SubscriberServerInterceptorFactoryProtocol: Sendable {

  /// - Returns: Interceptors to use when handling 'createSubscription'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeCreateSubscriptionInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_Subscription, Google_Pubsub_V1_Subscription>]

  /// - Returns: Interceptors to use when handling 'getSubscription'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeGetSubscriptionInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_GetSubscriptionRequest, Google_Pubsub_V1_Subscription>]

  /// - Returns: Interceptors to use when handling 'updateSubscription'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeUpdateSubscriptionInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_UpdateSubscriptionRequest, Google_Pubsub_V1_Subscription>]

  /// - Returns: Interceptors to use when handling 'listSubscriptions'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeListSubscriptionsInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ListSubscriptionsRequest, Google_Pubsub_V1_ListSubscriptionsResponse>]

  /// - Returns: Interceptors to use when handling 'deleteSubscription'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeDeleteSubscriptionInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_DeleteSubscriptionRequest, SwiftProtobuf.Google_Protobuf_Empty>]

  /// - Returns: Interceptors to use when handling 'modifyAckDeadline'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeModifyAckDeadlineInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ModifyAckDeadlineRequest, SwiftProtobuf.Google_Protobuf_Empty>]

  /// - Returns: Interceptors to use when handling 'acknowledge'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeAcknowledgeInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_AcknowledgeRequest, SwiftProtobuf.Google_Protobuf_Empty>]

  /// - Returns: Interceptors to use when handling 'pull'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makePullInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_PullRequest, Google_Pubsub_V1_PullResponse>]

  /// - Returns: Interceptors to use when handling 'streamingPull'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeStreamingPullInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_StreamingPullRequest, Google_Pubsub_V1_StreamingPullResponse>]

  /// - Returns: Interceptors to use when handling 'modifyPushConfig'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeModifyPushConfigInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ModifyPushConfigRequest, SwiftProtobuf.Google_Protobuf_Empty>]

  /// - Returns: Interceptors to use when handling 'getSnapshot'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeGetSnapshotInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_GetSnapshotRequest, Google_Pubsub_V1_Snapshot>]

  /// - Returns: Interceptors to use when handling 'listSnapshots'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeListSnapshotsInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_ListSnapshotsRequest, Google_Pubsub_V1_ListSnapshotsResponse>]

  /// - Returns: Interceptors to use when handling 'createSnapshot'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeCreateSnapshotInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_CreateSnapshotRequest, Google_Pubsub_V1_Snapshot>]

  /// - Returns: Interceptors to use when handling 'updateSnapshot'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeUpdateSnapshotInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_UpdateSnapshotRequest, Google_Pubsub_V1_Snapshot>]

  /// - Returns: Interceptors to use when handling 'deleteSnapshot'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeDeleteSnapshotInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_DeleteSnapshotRequest, SwiftProtobuf.Google_Protobuf_Empty>]

  /// - Returns: Interceptors to use when handling 'seek'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeSeekInterceptors() -> [ServerInterceptor<Google_Pubsub_V1_SeekRequest, Google_Pubsub_V1_SeekResponse>]
}

internal enum Google_Pubsub_V1_SubscriberServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Subscriber",
    fullName: "google.pubsub.v1.Subscriber",
    methods: [
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.createSubscription,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.getSubscription,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.updateSubscription,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.listSubscriptions,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.deleteSubscription,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.modifyAckDeadline,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.acknowledge,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.pull,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.streamingPull,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.modifyPushConfig,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.getSnapshot,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.listSnapshots,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.createSnapshot,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.updateSnapshot,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.deleteSnapshot,
      Google_Pubsub_V1_SubscriberServerMetadata.Methods.seek,
    ]
  )
